        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-6">
              {about.stats.map((stat, idx) => (
                <div key={idx} className="glass p-6 rounded-2xl border border-white/5 text-center transition-transform hover:scale-105">
          ...
          >
            <div className="space-y-6">
              ...
              <div className="glass p-8 rounded-[2rem] border border-white/5 hover:border-primary/20 transition-all translate-x-4">
